...
<head>
  ...
  <title>Becki's Job Search Site</title>
</head>
  ...
  <header class="bg-blue-900 text-white p-4">
    <div class="container mx-auto flex justify-between items-center">
      <h1 class="text-3xl font-semibold">
        <a href="index.html">Becki's Job Search Site</a>
      </h1>
      <nav class="space-x-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div class="rounded-lg shadow-md bg-white">
          <div class="p-4">
            ...
            <ul class="my-4 bg-gray-100 p-4 rounded">
              <li class="mb-2"><strong>Salary:</strong> 80,000 SEK</li>
              <li class="mb-2">
                <strong>Location:</strong> Stockholm
        ...
        <div class="rounded-lg shadow-md bg-white">
          <div class="p-4">
            ...
            <ul class="my-4 bg-gray-100 p-4 rounded">
              <li class="mb-2"><strong>Salary:</strong> 70,000 SEK</li>
              <li class="mb-2">
                <strong>Location:</strong> Gothenburg
        ...
        <div class="rounded-lg shadow-md bg-white">
          <div class="p-4">
            ...
            <ul class="my-4 bg-gray-100 p-4 rounded">
              <li class="mb-2"><strong>Salary:</strong> 75,000 SEK</li>
              <li class="mb-2">
                <strong>Location:</strong> Sundsvall
                <span class="text-xs bg-blue-500 text-white rounded-full px-2 py-1 ml-2">Local</span>
              </li>
              <li class="mb-2">
        ...
        <div class="rounded-lg shadow-md bg-white">
          <div class="p-4">
            ...
            <ul class="my-4 bg-gray-100 p-4 rounded">
              <li class="mb-2"><strong>Salary:</strong> 65,000 SEK</li>
              <li class="mb-2">
                <strong>Location:</strong> Lund
                <span class="text-xs bg-blue-500 text-white rounded-full px-2 py-1 ml-2">Remote</span>
              </li>
              <li class="mb-2">
        ...
        <div class="rounded-lg shadow-md bg-white">
          <div class="p-4">
            ...
            <ul class="my-4 bg-gray-100 p-4 rounded">
              <li class="mb-2"><strong>Salary:</strong> 60,000 SEK</li>
              <li class="mb-2">
        ...
        <div class="rounded-lg shadow-md bg-white">
          <div class="p-4">
            ...
            <ul class="my-4 bg-gray-100 p-4 rounded">
              <li class="mb-2"><strong>Salary:</strong> 90,000 SEK</li>
              <li class="mb-2">
                <strong>Location:</strong> Stockholm
                <span class="text-xs bg-blue-500 text-white rounded-full px-2 py-1 ml-2">Remote</span>
              </li>
